<h1>
    <img src="https://raw.githubusercontent.com/alexander-kiriliuk/k-platform-core/master/guide/kp-logo.png" alt="logo" height="20"/> K-Platform is a framework for the rapid development of modern applications
</h1>
...
- [Users](guide/users/index.md): provide scalable functionality for managing system users. Supports password hashing, user profile management with role-based access control.
...
<a target="_blank" href="https://nestjs.com" rel="nofollow">
    <img height="30" title="NestJs" src="guide/res/nestjs-logo.svg"/>
</a>
&nbsp; &nbsp; &nbsp; &nbsp;
<a target="_blank" href="https://typeorm.io" rel="nofollow">
    <img height="30" title="TypeORM" src="guide/res/typeorm-logo.png"/>
</a>
&nbsp; &nbsp; &nbsp; &nbsp;
<a target="_blank" href="https://redis.io" rel="nofollow">
    <img height="30" title="Redis" src="guide/res/redis-logo.svg"/>
</a>
